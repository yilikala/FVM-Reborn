...
if global.debug{
	if keyboard_check_pressed(ord("M")){
		...
		var inst = instance_create_depth(grid_pos.x,grid_pos.y+38,0,obj_seahorse_mouse)
	...
	if keyboard_check_pressed(ord("N")){
		...
		instance_create_depth(enemy_pos.x-80,enemy_pos.y+33,-200,obj_machine_shark_2)
		boss_count++
		//var grid_pos = get_grid_position_from_world(mouse_x,mouse_y)
	...
	if keyboard_check_pressed(ord("L")){
		var grid_pos = get_grid_position_from_world(mouse_x,mouse_y)
		var inst = instance_create_depth(grid_pos.x,grid_pos.y+38,0,obj_oyster_mouse)
		inst.grid_row = grid_pos.row
		inst.grid_col = grid_pos.col
		inst.frozen_timer = 0000
	}
