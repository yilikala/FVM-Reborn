...
switch(ghost_shape) {
    case 0: sprite_index = spr_death_scythe_effect; break;
    case 1: sprite_index = spr_death_scythe_effect_1; break;
    case 2: sprite_index = spr_death_scythe_effect_2; break;
}
